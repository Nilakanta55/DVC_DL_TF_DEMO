...
def prepaer_base_model(config_path, params_path):
...
if __name__ == '__main__':
    ...
    try:
        logging.info(">>>> stage 02 added")
        prepaer_base_model(config_path=parsed_args.config, params_path=parsed_args.params)
