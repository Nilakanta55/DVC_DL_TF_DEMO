...
def load_full_model(untuntrained_full_model_path):
    model = tf.keras.models.load_model(untuntrained_full_model_path)
    logging.info(f"untrained model is read from:{untuntrained_full_model_path}")
    return model